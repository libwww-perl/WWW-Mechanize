...
my $mech = WWW::Mechanize->new( cookie_jar => undef, autocheck => 0, strict_forms => 1, verbose_forms => 1 );
...
{
    $mech->get(URI::file->new_abs( 't/form_with_fields_verbose.html' )->as_string);
    my $form;
    cmp_deeply(
